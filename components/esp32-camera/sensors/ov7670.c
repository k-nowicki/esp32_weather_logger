 ...
 */
static int ov7670_write_array(cam_sensor_t *sensor, struct regval_list *vals)
{
int ret = 0;
 ...
 */
static int ov7670_frame_control(cam_sensor_t *sensor, int hstart, int hstop, int vstart, int vstop)
{
...
int ov7670_init(cam_sensor_t *sensor)
{
