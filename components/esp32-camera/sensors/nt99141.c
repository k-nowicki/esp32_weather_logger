...
static int set_pll(cam_sensor_t *sensor, bool bypass, uint8_t multiplier, uint8_t sys_div, uint8_t pre_div, bool root_2x, uint8_t seld5, bool pclk_manual, uint8_t pclk_div)
{
    return -1;
}
...
int nt99141_init(cam_sensor_t *sensor)
{
    sensor->reset = reset;
