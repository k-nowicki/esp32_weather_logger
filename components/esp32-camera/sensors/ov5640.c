...
//static void dump_reg(cam_sensor_t *sensor, const uint16_t reg){
...
//}
//
//static void dump_range(cam_sensor_t *sensor, const char * name, const uint16_t start_reg, const uint16_t end_reg){
...
//}
//
//static void dump_regs(cam_sensor_t *sensor){
...
static int set_pll(cam_sensor_t *sensor, bool bypass, uint8_t multiplier, uint8_t sys_div, uint8_t pre_div, bool root_2x, uint8_t pclk_root_div, bool pclk_manual, uint8_t pclk_div){
    int ret = 0;
...
static int set_image_options(cam_sensor_t *sensor)
{
    int ret = 0;
    uint8_t reg20 = 0;
    uint8_t reg21 = 0;
...
static int set_hmirror(cam_sensor_t *sensor, int enable)
{
    int ret = 0;
...
static int set_vflip(cam_sensor_t *sensor, int enable)
{
    int ret = 0;
...
static int set_quality(cam_sensor_t *sensor, int qs)
{
    int ret = 0;
...
static int set_gain_ctrl(cam_sensor_t *sensor, int enable)
{
    int ret = 0;
...
static int set_exposure_ctrl(cam_sensor_t *sensor, int enable)
{
    int ret = 0;
...
static int set_whitebal(cam_sensor_t *sensor, int enable)
{
    int ret = 0;
...
static int get_agc_gain(cam_sensor_t *sensor)
{
...
static int get_aec_value(cam_sensor_t *sensor)
{
...
static int set_gainceiling(cam_sensor_t *sensor, gainceiling_t level)
{
...
static int get_denoise(cam_sensor_t *sensor)
{
...
int ov5640_init(cam_sensor_t *sensor)
{
    sensor->reset = reset;
