...
static int set_regs(cam_sensor_t *sensor, const uint8_t (*regs)[2], uint32_t regs_entry_len)
{
    int i=0, res = 0;
...
static int set_reg_bits(cam_sensor_t *sensor, int reg, uint8_t offset, uint8_t length, uint8_t value)
{
    int ret = 0;
...
static int set_raw_gma(cam_sensor_t *sensor, int enable)
{
    int ret = 0;
...
static int set_awb_gain(cam_sensor_t *sensor, int value)
{
    int ret = 0;
...
static int set_window(cam_sensor_t *sensor, int offset_x, int offset_y, int w, int h)
{
    int ret = 0;
...
int sc101iot_init(cam_sensor_t *sensor)
{
