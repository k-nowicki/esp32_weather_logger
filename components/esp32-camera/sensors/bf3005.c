...
static int set_colorbar(cam_sensor_t *sensor, int value)
{
    int ret=0;
...
static int set_agc_gain(cam_sensor_t *sensor, int option)
{
    int ret = 0;
...
static int set_awb_gain_dsp(cam_sensor_t *sensor, int value)
{
    int ret = 0;
...
int bf3005_init(cam_sensor_t *sensor)
{
