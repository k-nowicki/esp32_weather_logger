...
static int set_dummy(cam_sensor_t *sensor, int val)
{
    ESP_LOGW(TAG, "dummy Unsupported");
    return -1;
}
static int set_gainceiling_dummy(cam_sensor_t *sensor, gainceiling_t val)
{
...
int bf20a6_init(cam_sensor_t *sensor)
{
